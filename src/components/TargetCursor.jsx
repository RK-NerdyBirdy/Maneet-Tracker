...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const scrollHandler = () => {
      ...
      // Re-measure the target after the scroll and update the bracket
      // destinations — the running ticker then glues the brackets to the
      // box's new position instead of freezing at the pre-scroll spot.
